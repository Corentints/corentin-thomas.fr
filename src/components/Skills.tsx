...
import backgroundImage from '../images/background-skills.jpg'
...
export function Skills() {
  ...
  useEffect(() => {
    ...
    function onMediaQueryChange(matches: unknown) {
  ...
  return (
    ...
    >
      ...
      <Container className="relative">
        <SectionHeading number="3">Compétences</SectionHeading>
              ...
              <Tab.Panels className="lg:col-span-7">
                {features.map((feature) => (
                  <Tab.Panel key={feature.title} unmount={false}>
                    ...
                    <div className="relative mt-10 aspect-[1085/730] w-[45rem] overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-violet-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
                      <Image
                        src={feature.image}
                        alt=""
                        layout="fill"
