...
export function Seo() {
    ...
    const description = 'Corentin THOMAS, développeur web freelance à Metz. Création ou refonte de site internet, intégration, réferencement, développement mobile, ...'
